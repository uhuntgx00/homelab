...
| ---- | ---- | ----------- |
| ![ansible](https://simpleicons.org/icons/ansible.svg){:height="32px" width="32px"} | [Ansible](https://www.ansible.com) | Automate bare metal provisioning and configuration |
